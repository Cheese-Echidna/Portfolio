...
export interface InitOutput {
  ...
  readonly closure2856_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure2864_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb7420ddf386ffb49: (a: number, b: number) => void;
  readonly closure2890_externref_shim: (a: number, b: number, c: any, d: any) => void;
