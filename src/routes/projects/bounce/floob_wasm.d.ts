...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb3ef16150bcb4dc4: (a: number, b: number) => void;
  readonly closure26_externref_shim: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly __externref_table_alloc: () => number;
  readonly closure61_externref_shim: (a: number, b: number, c: number, d: number) => void;
