...
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb3ef16150bcb4dc4(a: number, b: number): void;
export function closure26_externref_shim(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function __externref_table_alloc(): number;
export function closure61_externref_shim(a: number, b: number, c: number, d: number): void;
