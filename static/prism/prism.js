/* PrismJS 1.30.0
https://prismjs.com/download#themes=prism-dark&languages=markup+css+clike+javascript+bash+c+csharp+cpp+elixir+erlang+excel-formula+haskell+java+javadoc+javadoclike+jsdoc+js-extras+json+json5+jsonp+plsql+powershell+python+rust+sql+typescript+zig */
